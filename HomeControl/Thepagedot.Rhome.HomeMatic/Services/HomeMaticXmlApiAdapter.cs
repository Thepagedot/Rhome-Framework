...
{
	public class HomeMaticXmlApiAdapter : IHomeControlAdapter
	{
		...
		public HomeMaticXmlApiAdapter(Ccu ccu, bool isDemoMode = false, string owner = null)
		{
			this.Ccu = ccu;
		...
		public async Task<IEnumerable<Room>> GetRoomsAsync()
		{
			...
			foreach (var xmlRoom in xmlRoomList.Descendants("room"))
			{
				...
				roomList.Add(new HomeMaticRoom(roomName, roomIseId, channelIdsForRoomList, this));
			}
